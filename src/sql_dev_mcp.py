...
LOG_FILE = os.path.join(os.path.dirname(__file__), 'sql_dev_mcp.log')
...
# --- End of Error Logging ---
    ...
    nest_asyncio.apply()
    mcp = FastMCP("SQL-Server-Work")

    # Your SQLAlchemy connection URL
    SQL_URL = "mssql+pyodbc://SDHQHOPSQL01D/AOBAFin?trusted_connection=yes&driver=ODBC+Driver+17+for+SQL+Server"
